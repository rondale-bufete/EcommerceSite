...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light sticky px-2 py-3 container-fluid">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                ...
                <form action="" method="get" class="d-flex" role="search">
                    <!-- <a class="mx-5 login-btn" href="#">Login</a> -->
                </form>
            </div>
        </div>
    </nav>
                    ...
                    <div class="col-md-6 mt-5">
                        ...
                        <div class="form-container" id="formContain">
                            ...
                            <form action="" method="post" id="LoginForm">
                                ...
                                <div class="g-recaptcha" data-sitekey="6LdMVlIqAAAAANrq8SxiwJ_LminJo1NGGLkiMPe_" data-callback="enableSubmitButton"></div>
                                <button name="user_login" id="ButtonLogin" type="submit" class="btn" disabled="disabled">Login</button>
                                <br>
                            ...
                            <form action="" method="post" id="RegForm" enctype="multipart/form-data">
                                ...
                                <input type="email" id="reg_email" name="req_email" placeholder="Email" autocomplete="off" required>

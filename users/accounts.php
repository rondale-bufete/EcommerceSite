...
<head>
    ...
    <title>Ecommerce Site | Registration</title>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                ...
                <form action="search_product.php" method="get" class="d-flex" role="search">
                    ...
                    if (!isset($_SESSION['username'])) {
                        echo "<a class='mx-1 login-btn' style='font-size: 16px;' href='user_login.php'>Login</a>";
                    } else {
                        echo "<a class='logout-btn' style='font-size: 16px;' href='logout.php'>Logout</a>";
                    }
    ...
    <script>
        ...
        function login() {
            RegForm.style.transform = "translateX(690px)";
            LoginForm.style.transform = "translateX(690px)";
